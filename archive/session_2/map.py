...
print('\n')
#the func is the test_func
#what does test2 do here?
#why is line 8 in brackets? [func(arr[0])]
#is this function compounding?

#am i right to assume what this is doing is mapping an array from 0, 1, 2, 3 to 1, 2, 3, 4?
#could this kind of mapping be useful converting sets of numbers like rgb to hsl or audio scale info?
