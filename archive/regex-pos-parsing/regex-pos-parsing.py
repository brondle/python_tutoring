...
reggy = nltk.Text(corpus.words('LyricsAll.txt'))
# reggy = nltk.Text(corpus.words('artistStatements.txt'))
print (reggy.findall(r"<every>(<.*>)"))
print('\n')

# print reggy.findall(r"<This>(<.*>)<is>")
# print reggy.findall(r"<salvation>(<.*>)<aspire>")

# print(reggy.findall(r"<the> (<\.*>)"))
# print "/////////"
# print reggy.findall(r"<\w*> <sound> <\w*s>")
# print reggy.findall(r"<\w*> <noise> <\w*s>")
# print "/////////"
# print reggy.findall(r"<.*> <noise> <.*>")
# print reggy.findall(r"<.*><.*> <noise><.*> <.*>")
# print reggy.findall(r"<.*><.*> <loud><.*> <.*>")
# print reggy.findall(r"<.*><.*> <sound><.*> <.*>")
# print reggy.findall(r"<.*><.*> <echoes><.*> <.*>")
# print reggy.findall(r"<.*><.*> <echo><.*> <.*>")

# print reggy.findall(r"<.*> <we> <.*>")
# phraseEnding = reggy.findall(r"<.*><.*><great>")
